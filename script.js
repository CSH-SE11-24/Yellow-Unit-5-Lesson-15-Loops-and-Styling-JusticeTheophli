...
let bodyElement = document.body;
  console.log("Body selected successfully:",
  bodyElement);
...
console.log("All Off button selected successfully:", allOffButton)
...
console.log("Number of lightbulbs selected successfully:", lightBulb.length)
...
allOffButton.addEventListener("click", function(event) {
  for(let i = 0; i < lightBulb. length; i++){
    lightBulb[i].style.backgroundColor =
      "black";
  }
})
